...
public class Utils {
    public  static void int2byte_le(int from, byte[] to, int offset){
    ...
    public static int byte2int_le(byte[] from, int offset){
    ...
    public static void int2byte_be(int from, byte[] to, int offset){
    ...
    public static int byte2int_be(byte[] from, int offset){
    ...
    public static void short2byte_le(int from, byte[] to, int offset){
        to[offset + 1] = (byte)((from >> 8) & 0xFF);
        to[offset + 0] = (byte)(from & 0xFF);
    }

    public static int byte2short_le(byte[] from, int offset){
    ...
    public static void short2byte_be(int from, byte[] to, int offset){
        to[offset + 0] = (byte)((from >> 8) & 0xFF);
        to[offset + 1] = (byte)(from & 0xFF);
    }
    public static int byte2short_be(byte[] from, int offset){
        int v = (int)(from[offset + 0] & 0xFF);
        v <<= 8;
        v |= (int)(from[offset + 1] & 0xFF);
        return v;
    ...
    public static int cksum(byte[] buf, int offset, int size){
        int ret = 0;
        while(size-- != 0)
