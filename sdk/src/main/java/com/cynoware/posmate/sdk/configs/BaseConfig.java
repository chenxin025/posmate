...
public abstract class BaseConfig {
    ...
    public static final int COM_PORT_0 = 0;
    public static final int COM_PORT_1 = 1;
    public static final int COM_PORT_2 = 2;

    //NP11 and NP10 led config
    public static final int NP10_OR_NP11_LED_PRORT_INNER = 6;
    public static final int NP10_OR_NP11_PRORT_COM1 = 1;
    public static final int NP10_OR_NP11_PRORT_COM2 = 0;
