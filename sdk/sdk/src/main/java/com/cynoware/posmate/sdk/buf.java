...
public class buf {
    ...
    int pushBack(byte[] buffer, int offset, int size){
        int end;
        int freeSize = free();
    ...
    int pushFront(byte[] buffer, int offset, int size){
        int start;
        int freeSize = free();
        int copySize = (freeSize < size ? freeSize : size);
    ...
    int popFront(byte[] buffer, int offset, int size){
        int start;
        int usedSize = size();
    ...
    int popBack(byte[] buffer, int offset, int size){
        int end;
        int usedSize = size();
        int copySize = (usedSize < size ? usedSize : size);
    ...
    byte bufGetAt(int index){
        index = start_ + index;
        while(index > bufferSize_) index -= bufferSize_;
        return buffer_[index];
    }

    void bufSetAt(int index, byte ch){
        index = start_ + index;
        while(index > bufferSize_) index -= bufferSize_;
        buffer_[index] = ch;
    }
