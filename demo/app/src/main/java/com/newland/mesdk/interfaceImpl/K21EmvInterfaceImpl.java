...
import com.newland.mesdk.moduleinterface.EmvInterface;
import com.newland.mesdk.util.ModuleBase;

/**
 * Created by YJF K21连接方式下的EMV模块接口实现类
 */
public class K21EmvInterfaceImpl extends ModuleBase implements EmvInterface {
	private EmvModule emvModule;

	public K21EmvInterfaceImpl() {
		emvModule = (EmvModule) factory.getExModule("EMV_INNERLEVEL2");
	}
...
//		}
	...
	public List<PbocTransLog> fetchPbocLog() {
		List<PbocTransLog> listPbocTransLog = emvModule.fetchPbocLog();
	...
	public EmvCardInfo getAccountInfo(Set<Integer> tags) {
		EmvCardInfo emvCardInfo = emvModule.getAccountInfo(tags);
		return emvCardInfo;
	}
