...
import com.newland.mesdk.moduleinterface.RFCardInterface;
import com.newland.mesdk.util.ModuleBase;

/**
 * Created by HJP 非接卡模块接口实现
 */
public class RFCardInterfaceImpl extends ModuleBase implements RFCardInterface {
	private RFCardModule rfCardModule;

	public RFCardInterfaceImpl() {
		rfCardModule = (RFCardModule) factory.getModule(ModuleType.COMMON_RFCARDREADER);
	}
